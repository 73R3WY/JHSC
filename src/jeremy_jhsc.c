/*
This is the source code for Jeremy's Hotspot Creator
*/
...
void menu(void) {
    while (1) {
        clearscreen();
        system("title JerJer wireLess suiTe v0.1 - Main Menu");
        system("color 0E");
        puts("\n\t\tThank you for using JerJer WS v0.1");
        puts("\n");
        puts("\tMain menu:\n");
        puts("\t[1] (H)otspot");
        puts("\t[2] (W)ireless");
...
menu_hotspot:
    ...
    while (1) {
        clearscreen();
        system("title JerJer wireLess suiTe v0.1 - HotSpot");
        system("color 0E");
        puts("\n\t\tHotSpot Options");
        puts("\n");
        puts("\tMenu:\n");
...
menu_wireless:
    ...
    while (1) {
        clearscreen();
        system("title JerJer wireLess suiTe v0.1 - Wireless");
        system("color 0E");
        puts("\n\t\tWireless Options");
        puts("\n");
        puts("\tMenu:\n");
...
menu_about:
    ...
    while (1) {
        echooff();
        clearscreen();
        system("title JerJer wireLess suiTe v0.1 - About");
        system("color 0E");
        puts("\n\t\tAbout");
        system("type *.txt");
        puts("\n\nPlease press the number or corresponding letter of your choice: ");
        ...
        if (choice == '1' || choice == 'w' || choice == 'W') {
            ...
            sleep(1);
            system("start http://jerjerapps.blogspot.com/");
            sleep(2);
            goto menu_about;
